...
export default function Flashcards() {
  ...
  if (step === 'generate') {
    return (
      <section className="min-h-screen px-4 py-8 text-white overflow-x-hidden">
      ...
      <section className="min-h-screen p-8 text-white">
        <div className="mx-auto max-w-lg">
          ...
          <div className="flex flex-col items-center gap-6">
           <div className="relative min-h-72 w-full max-w-full rounded-2xl border border-red-400/30 bg-gradient-to-br from-red-500/20 to-pink-500/10 p-6 backdrop-blur flex flex-col items-center justify-center">
